  ...
  <section class="ftco-section" style="height: auto; padding-top:4em !important;">
        ...
        <div class="col-lg-12 ftco-animate">
          ...
          <div class="expanded-content">
            <div class="story-wrap d-md-flex align-items-center mr-4">
              <div class="img" style="background-image: url('{{ asset('main-page/images/GAPanalisis.jpg') }}')"></div>

              <div class="text " style="margin-left:30px;flex: 0 0 50%;text-align:justify" >
                <h4>
                  <span>GAP análisis</span>
                </h4>

                <p>
                 El análisis GAP o análisis de brechas, consiste en una evaluación del desempeño del sistema de gestión de una organización, con la cual se busca validar el punto en que se encuentra y el punto al que quiere llegar en su desarrollo y crecimiento como organización.
                </p>
