...
<section class="ftco-section" style="margin-bottom: -88px !important; padding-top:4em !important;background:#fff">
      ...
      <div class="col-lg-12 ftco-animate">
        ...
        <div class="expanded-content">
          <div class="story-wrap d-md-flex align-items-center mr-4">
            <div class="img" style="background-image: url({{asset('main-page/images/auditoria.jpg')}})"></div>
            ...
            <div class="text " style="margin-left:30px;flex: 0 0 50%;text-align:justify">
              ...
              <p>
                La auditoría interna es un una actividad de evaluación independiente y objetiva, de los procesos de la
                organización y de los requisitos contenidos en las normas de los sistemas de gestión.
              </p>
