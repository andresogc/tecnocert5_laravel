 <!-- Hero Section Start -->
  <section class="hero-wrap hero-wrap-2" style="background-image: url('{{asset('main-page/images/banner_capacitacion.webp')}}')"
    >
    ...
    ">
          ...
          <div class="text w-100 text-center" style="padding-bottom: 40px;width: 60% !important;padding-right: 55px;">
