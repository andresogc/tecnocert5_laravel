            ...
            <nav>
                <ol class="flex items-center whitespace-nowrap min-w-0">
                    ...
                    <li class="text-[12px]"> <a class="flex items-center text-textmuted"
                            href="javascript:void(0);">Sección 2 - Video
                        </a> </li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="text-gray-500 dark:text-white/70 p-5 border ltr:border-l-0 rtl:border-r-0 rounded-sm ltr:rounded-tl-none rtl:rounded-tr-none dark:border-white/10 border-gray-200">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <div class="box-title">Video (Dimension recomendada: 1980 x 280 px)</div>
                                </div>
                                <div class="box-body">
                                    <div class="grid grid-cols-12 sm:gap-6">

                                        <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                                            <x-input-file-filepond  class="basic-filepond1" model="videoContent.media" multiple/>
                                        </div>


                                        <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                                            @if ($videoContent['currentMediaUrl'])
                                                <div class="mt-4 mb-6">
                                                    <label class="block text-sm font-medium text-gray-700 mb-2">Archivo actual:</label>

                                                    @if ($videoContent['currentMediaType'] === 'image')
                                                        <img src="{{ asset($videoContent['currentMediaUrl']) }}" alt="Fondo actual" class="rounded-lg shadow-md max-h-60 object-cover" style="width:200px;height:200px;background-size: cover; ">
                                                    @elseif ($videoContent['currentMediaType'] === 'video')
                                                        <video controls class="rounded-lg shadow-md max-h-60" autoplay muted loop>
                                                            <source src="{{ asset($videoContent['currentMediaUrl']) }}" type="video/mp4">
