    ...
    <nav class="main-header" aria-label="Global">
        <div class="main-header-container !px-[0.85rem]">
                ...
                <div class="header-element">
                    <div class="horizontal-logo">
                        <a href="{{ route('dashboard') }}" class="header-logo">
                            <img src="{{asset('admin/app/assets/images/brand-logos/desktop-logo.png')}}" alt="logo"
                                class="desktop-logo">
                            <img src="{{asset('admin/app/assets/images/brand-logos/toggle-logo.png')}}" alt="logo"
                                class="toggle-logo">
                            <img src="{{asset('admin/app/assets/images/brand-logos/desktop-dark.png')}}" alt="logo"
                                class="desktop-dark">
                            <img src="{{asset('admin/app/assets/images/brand-logos/toggle-dark.png')}}" alt="logo"
                                class="toggle-dark">
                            <img src="{{asset('admin/app/assets/images/brand-logos/desktop-white.png')}}" alt="logo"
                                class="desktop-white">
                        </a>
                    </div>
                </div>
            ...
            <div class="header-content-right">
                        ...
                        <div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
                            <div class="py-2 first:pt-0 last:pb-0">
                                <div class="ti-dropdown-item !p-[0.65rem] ">
                                    <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                        <div class="flex items-center rounded-full">
                                            <img src="{{asset('admin/app/assets/images/flags/french_flag.jpg')}}" alt="flag-img"
                                ...
                                <div class="ti-dropdown-item !p-[0.65rem]">
                                    <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                        <div class="flex items-center rounded-full">
                                            <img src="{{asset('admin/app/assets/images/flags/germany_flag.jpg')}}" alt="flag-img"
                                                class="h-[1.1875rem] w-[1.1875rem] rounded-full">
                                        </div>
                                        <div>
                                            <p class="!text-[0.8125rem] font-medium">
                                ...
                                <div class="ti-dropdown-item !p-[0.65rem]">
                                    <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                        <div class="flex items-center rounded-full">
                                            <img src="{{asset('admin/app/assets/images/flags/italy_flag.jpg')}}" alt="flag-img"
                                                class="h-[1.1875rem] w-[1.1875rem] rounded-full">
                                        </div>
                                        <div>
                                            <p class="!text-[0.8125rem] font-medium">
                                ...
                                <div class="ti-dropdown-item !p-[0.65rem]">
                                    <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                        <div class="flex items-center rounded-full">
                                            <img src="{{asset('admin/app/assets/images/flags/russia_flag.jpg')}}" alt="flag-img"
                                                class="h-[1.1875rem] w-[1.1875rem] rounded-full">
                                        </div>
                                        <div>
                                            <p class="!text-[0.8125rem] font-medium">
                                ...
                                <div class="ti-dropdown-item !p-[0.65rem]">
                                    <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                                        <div class="flex items-center rounded-full">
                                            <img src="{{asset('admin/app/assets/images/flags/spain_flag.jpg')}}" alt="flag-img"
                                                class="h-[1.1875rem] w-[1.1875rem] rounded-full">
                                        </div>
                                        <div>
                                            <p class="!text-[0.8125rem] font-medium">
                ...
                {{-- <div
                    class="header-element py-[1rem] px-[0.65rem] notifications-dropdown header-notification hs-dropdown ti-dropdown !hidden md:!flex [--placement:bottom-right]">
                            ...
                            <li class="dropdown-item">
                                <div class="flex messages">
                                    ...
                                    <div>
                                        <div class="flex">
                                            <a href="chat.html">
                                                <h6 class="mb-1 text-[0.9rem] font-medium text-defaulttextcolor">
                                                    Petey Cruiser</h6>
                                            </a>
                                        </div>
                                        <p class="mb-0 text-[0.75rem] desc">I'm sorry but i'm not sure how to
                                            help you with that......</p>
                                        <p class="text-[11px] fonr-normal mb-0 text-start float-start ms-2 mt-2">
                                            Mar 15 3:55 PM</p>
                                    </div>
                                </div>
                            </li>
                            <li class="dropdown-item">
                                <div class="flex messages">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 text-[0.75rem] desc">All set ! Now, text-[11px]
                                            fonr-normal to get to you now......
                                        </p>
                                        <p class="text-[11px] fonr-normal mb-0 text-start float-start ms-2 mt-2">
                                            Mar 06 01:12 AM</p>
                                    </div>
                            ...
                            <li class="dropdown-item">
                                <div class="flex messages">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 text-[0.75rem] desc">Are you ready to pickup your
                                            Delivery...</p>
                                        <p class="text-[11px] fonr-normal mb-0 text-start float-start ms-2 mt-2">
                                            Feb 25 10:35 AM</p>
                                    </div>
                            ...
                            <li class="dropdown-item !rounded-bl-md !rounded-br-md">
                                <div class="flex messages">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 text-[0.75rem] desc">I'm sorry but i'm not sure how...
                                        </p>
                                        <p class="text-[11px] fonr-normal mb-0 text-start float-start ms-2 mt-2">
                                            Jan 29 03:16 PM</p>
                                    </div>
                        ...
                        <ul class="list-none mb-0" id="header-notification-scroll">
                            <li class="dropdown-item px-3">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="mail.html">
                                            <h5 class="notification-label text-defaulttextcolor mb-1">New files
                                                available</h5>
                                        </a>
                            ...
                            <li class="dropdown-item px-3">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="mail.html">
                                            <h5 class="notification-label text-defaulttextcolor mb-1">Updates
                                                Available</h5>
                                        </a>
                            ...
                            <li class="dropdown-item px-3">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="mail.html">
                                            <h5 class="notification-label text-defaulttextcolor mb-1">New Order
                                                Received</h5>
                                        </a>
                            ...
                            <li class="dropdown-item px-3">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="mail.html">
                                            <h5 class="notification-label text-defaulttextcolor mb-1">New review
                                                received</h5>
                                        </a>
                            ...
                            <li class="dropdown-item px-3">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-3">
                                        <a href="mail.html">
                                            <h5 class="notification-label text-defaulttextcolor mb-1">22
                            ...
                            <li class="dropdown-item px-3">
                                <div class="flex items-center !rounded-bl-md !rounded-br-md">
                                    ...
                                    <div class="ms-3">
                                        <a href="mail.html">
                                            <h5 class="notification-label text-defaulttextcolor mb-1">Project
                                                has been approved</h5>
                                        </a>
                ...
                {{-- <div class="header-element header-sidebar !hidden md:!flex">
                    <!-- Start::header-link-->
                    <a href="javascript:void(0);" class="header-link hs-dropdown-toggle"
                ...
                <!-- Header Profile -->
                <div
                    class="header-element md:!px-[0.5rem] px-2 hs-dropdown profile-dropdown !items-center ti-dropdown [--placement:bottom-right]">
                        ...
                        <ul class="dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu"
                                ...
                                <div class="main-header-profile bg-primary menu-header-content text-white">
                                    <div class="my-auto">
                                        <h6 class="mb-0 leading-none text-white">{{auth()->user()->name}}</h6><span
                                            class="text-[.6875rem] opacity-[0.7] leading-none">Administrador</span>
                                    </div>
                                </div>
                            </li>
                           {{--  <li><a class="dropdown-item text-defaulttextcolor flex " href="profile.html"><i
                            ...
                            <li><a 
                                ...
                                ><i
                                        class="bx bx-log-out text-[1.125rem] me-2 opacity-[0.7]"></i>Cerrar sesión</a>
                            </li>
                        </ul>
