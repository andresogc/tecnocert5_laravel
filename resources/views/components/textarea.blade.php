<div class="xl:col-span-12 lf:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
    ...
    <div class="relative">
        <textarea
            ...
            @class([
                'form-control placeholder:text-textmuted  .form-control-sm ti-form-input',
                '!border-danger' => $errors->has($model),
                '!border-success' => !$errors->has($model) && filled(data_get($this, $model)),
            ])
        ></textarea>
        {{-- Icono dinámico --}}
        @if ($errors->has($model))
        ...
        @elseif(filled(data_get($this, $model)))
            {{-- Ícono de success --}}
            <div class="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
