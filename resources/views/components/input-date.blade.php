    ...
    <div class="relative">
        <div class="form-group">
            <div class="input-group">
                <div class="input-group-text  text-[#8c9097]"> <i class="ri-calendar-line"></i> 
                    <input 
                        type="text" 
                        id="date" 
                        ...
                        value="{{ $value }}"
                        @class([
                            'form-control form-control !border-s-0 placeholder:text-textmuted !rounded-full .form-control-sm ti-form-input',
