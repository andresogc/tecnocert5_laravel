                        ...
                        <div class="box-body !p-0 customers mt-1">
                            <div class="ti-list-group ti-list-group-flush">
                                <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                    <div class="flex">
                                        <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                            src="{{asset('admin/app/assets/images/faces/3.jpg')}}" alt="Image description">
                                        <div class="flex-grow">
                                ...
                                <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                    <div class="flex">
                                        <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                            src="{{asset('admin/app/assets/images/faces/11.jpg')}}" alt="Image description">
                                        <div class="flex-grow">
                                            <div class="flex items-center">
                                                <div class="mt-1">
                                ...
                                <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                    <div class="flex">
                                        <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                            src="{{asset('admin/app/assets/images/faces/17.jpg')}}" alt="Image description">
                                        <div class="flex-grow">
                                            <div class="flex items-center">
                                                <div class="mt-1">
                                ...
                                <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                    <div class="flex">
                                        <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                            src="{{asset('admin/app/assets/images/faces/15.jpg')}}" alt="Image description">
                                        <div class="flex-grow">
                                            <div class="flex items-center">
                                                <div class="mt-1">
                                ...
                                <div class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-medium">
                                    <div class="flex">
                                        <img class="avatar avatar-md avatar-rounded my-auto me-4"
                                            src="{{asset('admin/app/assets/images/faces/6.jpg')}}" alt="Image description">
                                        <div class="flex-grow">
                                            <div class="flex items-center">
                                                <div class="mt-1">
                                                    ...
                                                    <p class="b-0 text-[.8125rem] text-textmuted mb-0">User ID:
                                                        #1234 <span class="text-success ms-2 inline-block">Paid</span>
                                                    </p>
                                                </div>
                                                <div class="ms-auto w-[45%] text-[1rem] mt-2">
                            ...
                            <ul class="timeline-1 mb-0">
                                <li class="!mt-0"> <i
                                    ...
                                    <span class="font-medium mb-4 text-[.875rem]">Total Products</span> <a
                                        href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">3
                                        days ago</a>
                                ...
                                <li class="!mt-0"> <i
                                    ...
                                    <span class="font-medium mb-4 text-[.875rem]">Total Sales</span> <a
                                        href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">35
                                        mins ago</a>
                                ...
                                <li class="!mt-0"> <i
                                    ...
                                    <span class="font-medium mb-4 text-[.875rem]">Total Revenue</span> <a
                                        href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">50
                                        mins ago</a>
                                    <p class="mb-0 text-textmuted text-[.75rem]">23.5K New Revenue</p>
                                </li>
                                <li class="!mt-0"> <i
                                        class="fe fe-box bg-warning-gradient text-fixed-white product-icon"></i>
                                    <span class="font-medium mb-4 text-[.875rem]">Total Profit</span> <a
                                        href="javascript:void(0);" class="float-end text-[.6875rem] text-textmuted">1
                                        hour ago</a>
                                    <p class="mb-0 text-textmuted text-[.75rem]">3k New profit</p>
                                </li>
                                <li class="!mt-0"> <i
                                        class="fe fe-eye bg-purple-gradient text-fixed-white product-icon"></i>
                        ...
                        <div class="box-body sales-info !pb-0 !pt-0 !mt-0">
                            ...
                            <div class="grid grid-cols-12 gap-x-6 sales-infomation pb-0 mb-0 mx-auto w-full">
                                <div class="md:col-span-6 col-span-12 px-2">
                                    <p class="mb-0 flex"><span
                                            class="legend bg-primary !rounded-[0.13]"></span>Delivered</p>
                                ...
                                <div class="md:col-span-6 col-span-12 px-2">
                                    <p class="mb-0 flex"><span class="legend bg-info !rounded-[0.13]"></span>Cancelled
                                    </p>
                                ...
                                <div class="md:col-span-6 col-span-12">
                                    ...
                                    <div class="progress progress-style progress-sm">
                                        <div class="progress-bar bar-1 bg-primary-gradient" style="width: 80%"
                                            role="progressbar" aria-valuenow="78" aria-valuemin="0" aria-valuemax="78">
                                        </div>
                                    </div>
                                </div>
