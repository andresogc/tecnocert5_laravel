  ...
  <section class="ftco-section" style="padding-top:50px !important">
    <div class="container">
      <div class="row justify-content-center pb-5 mb-3">
        <div class="col-md-7 heading-section text-center ftco-animate">
          ...
          <h1 style="line-height: 1.5;
            ...
            font-weight: 400;font-size: 24px; text-align: center; text-transform:uppercase;"><strong> Preguntas
            </strong>frecuentes</h1>
...
@push('scripts')
  <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        fetch('{{ asset("main-page/data/faqs-gap.json") }}')
          .then(response => {
            if (!response.ok) {
