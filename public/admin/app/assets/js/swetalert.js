(function () {
  ...
  document.addEventListener("DOMContentLoaded", () => {
      Livewire.on('show-toast', (data) => {
          // Si viene como array (Livewire 3 a veces lo manda así), tomar el primero
          const toast = Array.isArray(data) ? data[0] : data;

          Swal.fire({
              position: 'top-end',
              icon: toast.type,   // success, error, warning, info
              title: toast.message,
              showConfirmButton: false,
              timer: 2000
          });
    ...
    Livewire.on('confirm-delete', (data) => {
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.isConfirmed) {
            ...
            // Emitimos evento que escucha el componente Livewire
