(function () {
  ...
  new SimpleBar(myElement, { autoHide: true }); */
  const cart = document.getElementById("header-cart-items-scroll");
if (cart instanceof HTMLElement) {
    new SimpleBar(cart, { autoHide: true });
}

const notify = document.getElementById("header-notification-scroll");
if (notify instanceof HTMLElement) {
    new SimpleBar(notify, { autoHide: true });
}
  /*End Sidemenu Scroll */
